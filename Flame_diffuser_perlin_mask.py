...
if __name__ == "__main__":
    ...
    if batch_generation:
        ...
        opt.outdir = f'./test_data/exp/perlin/'
        ...
        img_path = 'D:/Data/Flame 1/Images/Images/'
                ...
                with model.ema_scope():
                    ...
                    while i < num_sample:
                        try:
                            ...
                            prompt_1 = "wildfire in snow, flame and smoke, drone view, photo realistic, high resolution, 4k, HD"
                            ...
                            opt.strength = 0.5 #random.uniform(0.2, 0.7)
