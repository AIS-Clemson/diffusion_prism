            ...
            with model.ema_scope():
                ...
                while i < num_sample:
                    try:
                        ...
                        # opt.init_img = "./test_img/image_skeleton_dia.png"
                        # opt.init_img = "./train/21_manual1.gif"
                        opt.init_img = "./train/exp/sample/Group_3_DHSample_10_Branch_11.png"
                        ...
                        opt.strength = 0.3#random.uniform(0.1, 0.9)
                        # opt.scale = int(10/opt.strength)
                        noise_std = 0.01 #random.uniform(0, 1)
